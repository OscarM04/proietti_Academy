...
@section('content')
    ...
    <div class="row">
        <div class="col">
            ...
            @endif()
            <form action="/directivos" method="POST">
                @csrf
                <div class="form-group">
                    <label for="CIDirectivo "> CI </label>
                    <input type="text" class="form-control" id="CIDirectivo" name="CIDirectivo" placeholder="Escribe la cedula" value="{{ old('CIDirectivo') }}">            
                </div>
