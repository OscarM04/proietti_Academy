        ...
        <div class="col">
            ...
            <form action="/atletas" method="POST">
                ...
                <div class="form-group">
                    <label for="CIAtleta "> CI </label>
                    <input type="text" class="form-control" id="CIAtleta" name="CIAtleta" placeholder="Escribe la cedula" value="{{ old('CIAtleta') }}">            
                </div>

                <div class="form-group">
                    <label for="passport "> Pasaporte </label>
                    <input type="text" class="form-control" id="passport" name="passport" placeholder="Escribe el pasaporte" value="{{ old('passport') }}">            
                </div>
